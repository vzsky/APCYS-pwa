...
--
-- Host: localhost
-- Generation Time: Oct 29, 2018 at 01:51 PM
...
CREATE TABLE `User` (
  ...
  `first` varchar(40) COLLATE utf8_bin NOT NULL,
  `last` varchar(40) COLLATE utf8_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
('root', '[{\"db\":\"APCYS\",\"table\":\"announce\"},{\"db\":\"APCYS\",\"table\":\"User\"}]');
...
('root', '2018-10-29 12:51:28', '{\"Console\\/Mode\":\"collapse\"}');
