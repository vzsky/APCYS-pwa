...
-- Database: `APCYS`
--
CREATE DATABASE IF NOT EXISTS `APCYS` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `APCYS`;
...
INSERT INTO `User` (`id`, `Usr`, `Pwd`, `Name`, `Residence`, `PSRoom`, `Country`, `School`, `SciAct`, `PrjCode`, `Bud1`, `Bud2`, `Bud3`, `Bud4`, `Logged`, `Xcurs`, `S3`) VALUES
('0', 'admin', 'root', 'Administrator', 'cloud', 'https', 'World', 'KVIS', 'Organizer', '000', 'Adbud1', 'AdBud2', 'AdBud3', 'AdBud4', 0, 0, NULL),
('1', 'username', 'password', 'Natapat Chaiprawat', '1445', '321', 'Thailand', 'KVIS', 'gamma', '001', 'mybud1', 'myBud2', 'myBud3', 'myBud4', 1, 0, NULL),
('50', 'Fido', 'fido', 'TamaraLynn', 'B3', '3002', 'ENG', 'Hogwarts', 'CHE', '5001', 'Barry', 'Harry', NULL, NULL, 1, 0, NULL);
...
('root', '[{\"db\":\"APCYS\",\"table\":\"User\"},{\"db\":\"APCYS\",\"table\":\"announce\"}]');
...
('root', 'APCYS', 'User', '{\"sorted_col\":\"`id` ASC\"}', '2018-11-16 09:31:49');
...
('root', '2018-11-16 10:00:36', '{\"Console\\/Mode\":\"collapse\"}');
